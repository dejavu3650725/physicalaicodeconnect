...
import { Plug, Radar, Zap, BrainCircuit, Info, Ban } from 'lucide-react';
import { href } from '../lib/router.js';

/** 하드웨어 사양 카드 — 센서/출력은 칩, AI 융합 방법은 번호 카드로 구조화 */
export default function SpecCard({ hw, compact = false }) {
  ...
  return (
    <aside className="rounded-3xl bg-white border border-slate-200 shadow-[0_10px_30px_-20px_rgba(11,18,32,.35)] overflow-hidden">
      ...
      <div className={`px-5 pb-5 pt-4 space-y-5 ${compact ? 'text-sm' : ''}`}>
