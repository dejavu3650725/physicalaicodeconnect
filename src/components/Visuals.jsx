...
export default function Visual({ id }) {
  ...
  switch (id) {
    ...
    case 'drone-pair': scene = <><Drone x={40} y={40} led="#38bdf8" /><path d="M170 90 q40 -50 80 0" stroke="#38bdf8" strokeWidth="2" fill="none" strokeDasharray="4 4" /><Controller x={250} y={60} text="P 3초" /><text x="100" y="165" fontSize="11" fontWeight="800" fill="#0ea5e9" textAnchor="middle">흔들기 10초 → 빨강·파랑 깜빡</text><text x="310" y="165" fontSize="11" fontWeight="800" fill="#16a34a" textAnchor="middle">부저 + 초록 점등 = 완료</text></>; break;
    case 'drone-battery': scene = <><Drone x={40} y={40} led="#94a3b8" /><rect x="190" y="60" width="54" height="34" rx="6" fill="#334155" /><text x="217" y="81" fontSize="9" fill="#e2e8f0" textAnchor="middle" fontWeight="800">3.7V 300mAh</text><path d="M244 77 h30" stroke="#22c55e" strokeWidth="3" /><rect x="275" y="55" width="70" height="44" rx="8" fill="#1e293b" /><text x="310" y="73" fontSize="9" fill="#a3e635" textAnchor="middle" fontWeight="800">충전기 ⚡</text><text x="310" y="88" fontSize="9" fill="#cbd5e1" textAnchor="middle">약 40분</text><rect x="360" y="60" width="44" height="34" rx="6" fill="#334155" /><text x="382" y="81" fontSize="9" fill="#e2e8f0" textAnchor="middle" fontWeight="800">AAA×2</text><text x="210" y="165" fontSize="11" fontWeight="800" fill="#475569" textAnchor="middle">비행 5~6분 · 예비 배터리 로테이션</text></>; break;
    case 'drone-flat': scene = <><rect x="40" y="130" width="340" height="8" rx="2" fill="#94a3b8" /><Drone x={150} y={30} led="#facc15" /><Controller x={290} y={50} text="S 3초" /><text x="210" y="170" fontSize="11" fontWeight="800" fill="#475569" textAnchor="middle">평평한 곳에 두고 초기화 → 드리프트 예방</text></>; break;
